...
declare namespace game{
    class FirstPlatformTag extends ut.Component {
        constructor();
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: FirstPlatformTag): FirstPlatformTag;
        static _toPtr(p: number, v: FirstPlatformTag): void;
        static _tempHeapPtr(v: FirstPlatformTag): number;
        static _dtorFn(v: FirstPlatformTag): void;
    }
    class Jump extends ut.Component {
        constructor();
        jumpForce: number;
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: Jump): Jump;
        static _toPtr(p: number, v: Jump): void;
        static _tempHeapPtr(v: Jump): number;
        static _dtorFn(v: Jump): void;
    }
    class PlatformTag extends ut.Component {
        constructor();
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: PlatformTag): PlatformTag;
        static _toPtr(p: number, v: PlatformTag): void;
        static _tempHeapPtr(v: PlatformTag): number;
        static _dtorFn(v: PlatformTag): void;
    }
    ...
    class State extends ut.Component {
        constructor();
        IsPlaying: boolean;
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: State): State;
        static _toPtr(p: number, v: State): void;
        static _tempHeapPtr(v: State): number;
        static _dtorFn(v: State): void;
    }
}
declare namespace ut{
}
