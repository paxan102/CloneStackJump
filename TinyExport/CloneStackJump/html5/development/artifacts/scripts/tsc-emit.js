...
var game;
(function (game) {
    var JumpSystem = /** @class */ (function (_super) {
        __extends(JumpSystem, _super);
        function JumpSystem() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        JumpSystem.prototype.OnUpdate = function () {
            var _this = this;
            this.world.forEach([ut.Entity, game.Jump, ut.Physics2D.Velocity2D], function (entity, jump, velocity) {
